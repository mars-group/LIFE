...
namespace LifeAPI.Layer.Obstacle
{
    public interface IObstacleLayer : ILayer
    {
        ...
        double GetAccumulatedPathRating(IGeoCoordinate start, IGeoCoordinate destination, double failFastThreshold = double.MaxValue);
        ...
        /// <param name="failFastThreshold">The fail fast threshold (optional)</param>
        /// <returns>Accumulated path rating</returns>
        double GetAccumulatedPathRating(IGeoCoordinate start, double speed, double bearing, double failFastThreshold = double.MaxValue);
