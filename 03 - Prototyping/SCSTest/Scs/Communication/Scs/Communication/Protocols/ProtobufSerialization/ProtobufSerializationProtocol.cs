...
{
    class ProtobufSerializationProtocol : IScsWireProtocol
    {

        public ProtobufSerializationProtocol()
        {
            RuntimeTypeModel.Default.Add(typeof(IScsMessage), true);
            RuntimeTypeModel.Default.Add(typeof (ScsRemoteInvokeMessage), false).Add("ServiceClassName","MethodName","Parameters");
            RuntimeTypeModel.Default.Add(typeof(ScsRemoteInvokeReturnMessage), false).Add("ReturnValue","RemoteException");
