...
namespace MCastAddressGenerator {
    internal class Program {
        private static void Main(string[] args) {
            ...
            Console.WriteLine("MCast für Agent: 239.192." + GetMcastTuple(agentRand.Next()) + "." +
                              GetMcastTuple(agentRand.Next()));
            Console.WriteLine("MCast für AnotherAgent: 239.192." + GetMcastTuple(anotherAgentRand.Next()) + "." +
                              GetMcastTuple(anotherAgentRand.Next()));

            Console.ReadKey();
        }

        private static int GetMcastTuple(int randomValue) {
