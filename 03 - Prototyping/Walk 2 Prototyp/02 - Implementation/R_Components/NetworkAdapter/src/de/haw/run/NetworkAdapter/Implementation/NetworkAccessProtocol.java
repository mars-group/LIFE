...
import de.haw.run.GlobalTypes.Exceptions.TypeIsNotSerializableException;
...
class NetworkAccessProtocol {
     ...
     * @throws de.haw.run.NetworkAdapter.Interface.Exceptions.ConnectionLostException if socket not writable.
     */
