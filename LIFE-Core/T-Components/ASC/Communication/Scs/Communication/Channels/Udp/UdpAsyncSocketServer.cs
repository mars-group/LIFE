...
namespace ASC.Communication.Scs.Communication.Channels.Udp
{
    public class UdpAsyncSocketServer
    {
        ...
        private readonly int _numReadConnections
        ...
        public UdpAsyncSocketServer(int numReadConnections = 10, int numWriteConnections = 10,
        ...
        public void Start(IPEndPoint localEndPoint, IPAddress mcastAddress)
        {
            ...
            var localAddress = MulticastNetworkUtils.GetAllMulticastInterfaces()
                .First()
                .GetIPProperties()
                .UnicastAddresses
                .First(elem => elem.Address.AddressFamily ==
                               MulticastNetworkUtils.GetAddressFamily(IPVersionType.IPv4));
