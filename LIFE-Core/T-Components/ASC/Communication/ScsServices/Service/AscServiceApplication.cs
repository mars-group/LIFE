...
namespace ASC.Communication.ScsServices.Service
{
    ...
    internal class AscServiceApplication : IAscServiceApplication
    {
        ...
        public void AddService<TServiceInterface, TServiceClass>(TServiceClass service,
            Type typeOfTServiceInterface = null)
            ...
            where TServiceInterface : class
        {
            ...
            var serviceDict = _serviceObjects.GetOrAdd(typeOfTServiceInterface.Name,
                new ConcurrentDictionary<Guid, ServiceObject>());
        ...
        private static void SendInvokeResponse(IMessenger client, AscRemoteInvokeMessage requestMessage,
            object returnValue,
        ...
        private class ServiceObject
        {
            ...
            public ServiceObject(Type serviceInterfaceType, AscService service)
            {
                ...
                var classAttributes = serviceInterfaceType.GetTypeInfo()
                    .GetCustomAttributes(typeof(AscServiceAttribute), true)
                    .ToArray();
