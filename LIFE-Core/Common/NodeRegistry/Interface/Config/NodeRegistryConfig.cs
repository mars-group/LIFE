...
namespace NodeRegistry.Interface.Config {

  [Serializable]
  public class NodeRegistryConfig {

    public NodeRegistryConfig(TNodeInformation nodeinfo, bool addMyselfToActiveNodeList, int heartBeatInterval,
      int layerServiceStartPort = 39999, int heartbeatTimeoutMultiplier = 3) {
    ...
    public NodeRegistryConfig(NodeType nodeType, string nodeIdentifier, string nodeEndPointIp, int nodeEndPointPort,
      bool myselfToActiveNodeList, int layerServiceStartPort = 39999, int heartBeatInterval = 500,
      int heartbeatTimeoutMultiplier = 3) {
      NodeType = nodeType;
