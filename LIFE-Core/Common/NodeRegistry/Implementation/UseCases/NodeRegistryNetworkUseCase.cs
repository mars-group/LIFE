...
namespace NodeRegistry.Implementation.UseCases
{
    internal class NodeRegistryNetworkUseCase
    {
        ...
        private readonly JsonSerializerSettings _jset =
        ...
        {
            if (nodeRegistryConnectionInfoMessage == null) return false;

            // Heartbeat and Leave Messages are always ok
            if ((nodeRegistryConnectionInfoMessage.MessageType == NodeRegistryMessageType.Leave)
                || (nodeRegistryConnectionInfoMessage.MessageType == NodeRegistryMessageType.HeartBeat)) return true;
            ...
            if (connectionInfoMessage == null) return false;
