...
public class Client {
    public static void main(String[] args) throws Exception {
        ...
        //ClientConfig conf = new ClientConfig("janb", "highvoltage");
        //ClientConfig conf = new ClientConfig("guest", "guest");
        //myApp = ClientFactory.createClient(conf);
        ...
        try {
            ...
            myApp.callProcedure("Insert", "German", "Hallo", "Welt");
        } catch (Exception ex) {
		 ...
		 */
        final ClientResponse response = myApp.callProcedure("Select", "German");
