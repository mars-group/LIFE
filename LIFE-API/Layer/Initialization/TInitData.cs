...
namespace LIFE.API.Layer.Initialization
{
    ...
    public class TInitData
    {
        ...
        /// </summary>
        public List<AgentInitConfig> AgentInitConfigs { get; }
        ...
        {
            AgentInitConfigs.Add(
                new AgentInitConfig(agentName, agentFullName, agentAmount, offset, agentInitParameters));
        }
        ...
        {
            TimeSeriesInitInfo = new TimeSeriesInitConfig(tableName, databaseColumnName, clearColumnName,
                timeSeriesStartTime);
        }
    ...
    public class TimeSeriesInitConfig
    {
        ...
        public TimeSeriesInitConfig(string tableName, string databaseColumnName, string clearColumnName,
            DateTime timeSeriesStartTime = default(DateTime))
        {
            TableName = tableName;
