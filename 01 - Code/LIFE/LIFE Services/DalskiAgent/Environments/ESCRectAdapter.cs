...
namespace DalskiAgent.Environments {
  ...
  /// </summary>
  public class ESCRectAdapter : IEnvironmentOld, IDataSource {

    private readonly IEnvironment _esc; // Environment Service Component (ESC) implementation.
    ...
    public ESCRectAdapter(IEnvironment esc, Vector maxSize, bool gridMode) {
      _esc = esc;
      _gridMode = gridMode;
    ...
    public void AddObject(ISpatialObject obj, CollisionType collisionType, Vector pos, out DataAccessor acc, Vector dim,
      Direction dir) {
    ...
    /// <param name="dim">Dimension of the object. If null, then (1,1,1).</param>
    /// <param name="dir">Direction of the object. If null, then 0°.</param>
    public void AddObject(ISpatialObject obj, CollisionType collisionType, Vector minPos, Vector maxPos,
      out DataAccessor acc, Vector dim, Direction dir) {
      // Set default values to direction and dimension, if not given. Then create geometry and accessor.
      if (dir == null) dir = new Direction();
