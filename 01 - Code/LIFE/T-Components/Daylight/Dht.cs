...
namespace Daylight {
    ...
    public class Dht {
        ...
        private readonly KademliaNode dhtNode;
        ...
        public Dht(string overlayUrl, bool register) {
            ...
            foreach (string host in hosts) {
                ...
                if (parts.Length == 2) {
                    try {
                        ...
                        if (dhtNode.Bootstrap(bootstrapNode)) Console.WriteLine("OK!");
            ...
            if (dhtNode.JoinNetwork()) {
                ...
                if (register) {
                    ...
                    downloader.DownloadString(overlayUrl + REGISTER_FRAGMENT + ourPort);
        ...
        public string Get(string key) {
            ...
            if (found.Count > 0) return found[0]; // An arbitrary value
