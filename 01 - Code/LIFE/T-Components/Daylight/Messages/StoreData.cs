...
namespace Daylight.Messages {
    ...
    public class StoreData : Response {
        ...
        private readonly ID dataHash; // Distinguish multiple values for a given key
        ...
        public StoreData(ID nodeID, StoreResponse request, ID theKey, ID theDataHash, string theData,
            DateTime originalPublication) : base(nodeID, request) {
            key = theKey;
            data = theData;
