...
namespace ASC.Communication.ScsServices.Service {
    ...
    public static class AscServiceBuilder {
        ...
        /// <returns></returns>
        public static IScsServiceApplication CreateService(string address, string multicastGroup)
        {
            return new AscServiceApplication(ScsServerFactory.CreateServer(AscEndPoint.CreateEndPoint(address, multicastGroup)));
        }
    }
}