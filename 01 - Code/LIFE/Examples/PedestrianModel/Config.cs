...
namespace PedestrianModel {
    ...
    internal class Config {
        ...
        public static readonly TargetListType TargetListType = TargetListType.Sequential;
            // how to process the target positions

        public static readonly float TargetReachedDistance = 0.25f;
            // at what distance I have reached the target position

        public static readonly Vector PedestrianDimensions = new Vector(0.4f, 0.4f, 0.4f);
            // agents are 0.4m x 0.4m x 0.4m
