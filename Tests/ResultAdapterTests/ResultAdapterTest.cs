...
namespace ResultAdapterTests
{
    ...
    public class Grass : GridAgent<Grass>, ISimResult
    {
        ...
        public Grass(ILayer layer, RegisterAgent regFkt, UnregisterAgent unregFkt,
            IGridEnvironment<GridAgent<Grass>> env)
    ...
    public class Sheep : GridAgent<Sheep>, ISimResult
    {
        ...
        public Sheep(ILayer layer, RegisterAgent regFkt, UnregisterAgent unregFkt,
            IGridEnvironment<GridAgent<Sheep>> env)
            : base(layer, regFkt, unregFkt, env)
        {
            EnergyMax = 40;
        }
