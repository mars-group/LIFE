          ...
          if (noSqlEsc != null) {
            ...
            Parallel.For(0, 14500,
              i => {
                ...
                exploreShapes[i] = new Sphere(new Vector3(lat, 0, lon), GetDecimalDegreesByMeters(7000));
              });
        ...
        if (noSqlEsc != null) {
          ...
          for (var i = 0; i < ticks; i++) {
            ...
            foreach (var agent in agents)
              if (esc.Move(agent, new Vector3(random.Next(-2, 2), random.Next(-2, 2))).Success) movementSucess++;
              else collisions++;
            noSqlEsc.CommitTick();
      ...
      foreach (var esc in EnvironmentManager.GetAll()) {
        ...
        if (noSqlEsc != null) {
          ...
          for (var i = 0; i < ticks; i++) {
            ...
            (agents,
              agent => {
                if (esc.Move(agent, new Vector3(random.Next(-2, 2), 0, random.Next(-2, 2))).Success) movementSucess++;
                else collisions++;
              });
