...
namespace LIFE.Components.ObstacleLayer {
  ...
  public class ObstacleMap : IObstacleMap {
    ...
    public double GetAccumulatedPathRating(IGeoCoordinate start, IGeoCoordinate destination,
      ...
      return GetPathValueViaRaycastInGrid(start.Latitude, start.Longitude, destination.Latitude, destination.Longitude,
        failFastThreshold);
    }
    ...
    public ObstacleMapToAscDto ToAscDto() {
      ...
      return new ObstacleMapToAscDto(sortedCellContents, _numberOfGridCellsX, _numberOfGridCellsY, _topLat, _bottomLat,
