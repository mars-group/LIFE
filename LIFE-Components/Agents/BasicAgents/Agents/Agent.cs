...
namespace LIFE.Components.Agents.BasicAgents.Agents {
  ...
  public abstract class Agent : AscService, IAgent {
    ...
    public readonly ILayer Layer;                            // Layer reference needed for delegate calls.
    public Guid ID { get; }                                  // The agent identifier.
